...
private:
    static inline std::vector<BlockState> s_States = {};

public:
    static void initialize()
    {
        BlockStateRegistry::s_States.emplace_back(ACTIVE);
        BlockStateRegistry::s_States.emplace_back(AGE);
        BlockStateRegistry::s_States.emplace_back(AGE_BIT);
        {
        ...
        BlockStateRegistry::s_States.emplace_back(BOOKS_STORED);
        ...
        BlockStateRegistry::s_States.emplace_back(TWISTING_VINES_AGE);
        BlockStateRegistry::s_States.emplace_back(WEEPING_VINES_AGE);

        BlockStateRegistry::s_States.emplace_back(PILLAR_AXIS);
    };

    static const std::vector<BlockState>& getAll() { return BlockStateRegistry::s_States; };
};
