...
// Construction
ItemGroup ItemGroupRegistry::PLANKS = ItemGroup{ ItemCategory::Construction, "itemGroup.name.planks" };
ItemGroup ItemGroupRegistry::WALLS = ItemGroup{ ItemCategory::Construction, "itemGroup.name.walls" };
ItemGroup ItemGroupRegistry::FENCE = ItemGroup{ ItemCategory::Construction, "itemGroup.name.fence" };
ItemGroup ItemGroupRegistry::FENCE_GATE = ItemGroup{ ItemCategory::Construction, "itemGroup.name.fenceGate" };
ItemGroup ItemGroupRegistry::STAIRS = ItemGroup{ ItemCategory::Construction, "itemGroup.name.stairs" };
ItemGroup ItemGroupRegistry::DOORS = ItemGroup{ ItemCategory::Construction, "itemGroup.name.door" };
ItemGroup ItemGroupRegistry::TRAPDOOR = ItemGroup{ ItemCategory::Construction, "itemGroup.name.trapdoor" };
ItemGroup ItemGroupRegistry::CONSTRUCTION_EMPTY_1 { ItemCategory::Construction }; // Empty Group
ItemGroup ItemGroupRegistry::GLASS = ItemGroup{ ItemCategory::Construction, "itemGroup.name.glass" };
ItemGroup ItemGroupRegistry::GLASS_PANE = ItemGroup{ ItemCategory::Construction, "itemGroup.name.glassPane" };
ItemGroup ItemGroupRegistry::CONSTRUCTION_EMPTY_2 { ItemCategory::Construction }; // Empty Group
ItemGroup ItemGroupRegistry::SLAB = ItemGroup{ ItemCategory::Construction, "itemGroup.name.slab" };
ItemGroup ItemGroupRegistry::STONEBRICK = ItemGroup{ ItemCategory::Construction, "itemGroup.name.stoneBrick" };
ItemGroup ItemGroupRegistry::CONSTRUCTION_EMPTY_3 { ItemCategory::Construction }; // Empty Group
ItemGroup ItemGroupRegistry::SANDSTONE = ItemGroup{ ItemCategory::Construction, "itemGroup.name.sandstone" };
ItemGroup ItemGroupRegistry::CONSTRUCTION_EMPTY_4 { ItemCategory::Construction }; // Empty Group
ItemGroup ItemGroupRegistry::COPPER = ItemGroup{ ItemCategory::Construction, "itemGroup.name.copper" };
ItemGroup ItemGroupRegistry::CONSTRUCTION_EMPTY_5 { ItemCategory::Construction }; // Empty Group
ItemGroup ItemGroupRegistry::WOOL = ItemGroup{ ItemCategory::Construction, "itemGroup.name.wool" };
ItemGroup ItemGroupRegistry::WOOL_CARPET = ItemGroup{ ItemCategory::Construction, "itemGroup.name.woolCarpet" };
ItemGroup ItemGroupRegistry::CONCRETE_POWDER = ItemGroup{ ItemCategory::Construction, "itemGroup.name.concretePowder" };
ItemGroup ItemGroupRegistry::CONCRETE = ItemGroup{ ItemCategory::Construction, "itemGroup.name.concrete" };
ItemGroup ItemGroupRegistry::STAINED_CLAY = ItemGroup{ ItemCategory::Construction, "itemGroup.name.stainedClay" };
ItemGroup ItemGroupRegistry::GLAZED_TERRACOTTA = ItemGroup{ ItemCategory::Construction, "itemGroup.name.glazedTerracotta" };
...
ItemGroup ItemGroupRegistry::ORE = ItemGroup{ ItemCategory::Nature, "itemGroup.name.ore" };
ItemGroup ItemGroupRegistry::STONE = ItemGroup{ ItemCategory::Nature, "itemGroup.name.stone" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_2 { ItemCategory::Nature }; // Empty Group
ItemGroup ItemGroupRegistry::LOG = ItemGroup{ ItemCategory::Nature, "itemGroup.name.log" };
ItemGroup ItemGroupRegistry::WOOD = ItemGroup{ ItemCategory::Nature, "itemGroup.name.wood" };
ItemGroup ItemGroupRegistry::LEAVES = ItemGroup{ ItemCategory::Nature, "itemGroup.name.leaves" };
ItemGroup ItemGroupRegistry::SAPLING = ItemGroup{ ItemCategory::Nature, "itemGroup.name.sapling" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_3 { ItemCategory::Nature }; // Empty Group
ItemGroup ItemGroupRegistry::SEED = ItemGroup{ ItemCategory::Nature, "itemGroup.name.seed" };
ItemGroup ItemGroupRegistry::CROP = ItemGroup{ ItemCategory::Nature, "itemGroup.name.crop" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_4 { ItemCategory::Nature }; // Empty Group
ItemGroup ItemGroupRegistry::GRASS = ItemGroup{ ItemCategory::Nature, "itemGroup.name.grass" };
ItemGroup ItemGroupRegistry::CORAL = ItemGroup{ ItemCategory::Nature, "itemGroup.name.coral_decorations" };
ItemGroup ItemGroupRegistry::FLOWER = ItemGroup{ ItemCategory::Nature, "itemGroup.name.flower" };
ItemGroup ItemGroupRegistry::DYE = ItemGroup{ ItemCategory::Nature, "itemGroup.name.dye" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_5 { ItemCategory::Nature }; // Empty Group
ItemGroup ItemGroupRegistry::RAW_FOOD = ItemGroup{ ItemCategory::Nature, "itemGroup.name.rawFood" };
ItemGroup ItemGroupRegistry::MUSHROOM = ItemGroup{ ItemCategory::Nature, "itemGroup.name.mushroom" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_6 { ItemCategory::Nature }; // Empty Group
ItemGroup ItemGroupRegistry::MONSTER_STONE = ItemGroup{ ItemCategory::Nature, "itemGroup.name.monsterStoneEgg" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_7 { ItemCategory::Nature }; // Empty Group
ItemGroup ItemGroupRegistry::MOB_EGGS = ItemGroup{ ItemCategory::Nature, "itemGroup.name.mobEgg" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_8 { ItemCategory::Nature }; // Empty Group
ItemGroup ItemGroupRegistry::CORAL_BLOCKS = ItemGroup{ ItemCategory::Nature, "itemGroup.name.coral" };
ItemGroup ItemGroupRegistry::SCULK = ItemGroup{ ItemCategory::Nature, "itemGroup.name.sculk" };
ItemGroup ItemGroupRegistry::NATURE_EMPTY_9 { ItemCategory::Nature }; // Empty Group

// Equipment
ItemGroup ItemGroupRegistry::HELMET = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.helmet" };
ItemGroup ItemGroupRegistry::CHESTPLATE = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.chestplate" };
ItemGroup ItemGroupRegistry::LEGGINGS = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.leggings" };
ItemGroup ItemGroupRegistry::BOOTS = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.boots" };
ItemGroup ItemGroupRegistry::SWORD = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.sword" };
ItemGroup ItemGroupRegistry::AXE = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.axe" };
ItemGroup ItemGroupRegistry::PICKAXE = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.pickaxe" };
ItemGroup ItemGroupRegistry::SHOVEL = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.shovel" };
ItemGroup ItemGroupRegistry::HOE = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.hoe" };
ItemGroup ItemGroupRegistry::EQUIPMENT_EMPTY_1 { ItemCategory::Equipment }; // Empty Group
ItemGroup ItemGroupRegistry::ARROW = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.arrow" };
ItemGroup ItemGroupRegistry::EQUIPMENT_EMPTY_2 { ItemCategory::Equipment }; // Empty Group
ItemGroup ItemGroupRegistry::COOKED_FOOD = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.cookedFood" };
ItemGroup ItemGroupRegistry::MISC_FOOD = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.miscFood" };
ItemGroup ItemGroupRegistry::EQUIPMENT_EMPTY_3 { ItemCategory::Equipment }; // Empty Group
ItemGroup ItemGroupRegistry::GOAT_HORN = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.goatHorn" };
ItemGroup ItemGroupRegistry::EQUIPMENT_EMPTY_4 { ItemCategory::Equipment }; // Empty Group
ItemGroup ItemGroupRegistry::BUNDLES = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.bundles" };
ItemGroup ItemGroupRegistry::HORSE_ARMOR = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.horseArmor" };
ItemGroup ItemGroupRegistry::EQUIPMENT_EMPTY_5 { ItemCategory::Equipment }; // Empty Group
ItemGroup ItemGroupRegistry::POTION = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.potion" };
ItemGroup ItemGroupRegistry::SPLASH_POTION = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.splashPotion" };
ItemGroup ItemGroupRegistry::LINGERING_POTION = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.lingeringPotion" };
ItemGroup ItemGroupRegistry::OMINOUS_BOTTLE = ItemGroup{ ItemCategory::Equipment, "itemGroup.name.ominousBottle" };
...
ItemGroup ItemGroupRegistry::BED = ItemGroup{ ItemCategory::Items, "itemGroup.name.bed" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_2 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::CANDLES = ItemGroup{ ItemCategory::Items, "itemGroup.name.candles" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_3 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::ANVIL = ItemGroup{ ItemCategory::Items, "itemGroup.name.anvil" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_4 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::CHEST = ItemGroup{ ItemCategory::Items, "itemGroup.name.chest" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_5 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::SHULKER_BOX = ItemGroup{ ItemCategory::Items, "itemGroup.name.shulkerBox" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_6 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::RECORD = ItemGroup{ ItemCategory::Items, "itemGroup.name.record" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_7 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::SIGN = ItemGroup{ ItemCategory::Items, "itemGroup.name.sign" };
ItemGroup ItemGroupRegistry::HANGING_SIGN = ItemGroup{ ItemCategory::Items, "itemGroup.name.hanging_sign" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_8 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::SKULL = ItemGroup{ ItemCategory::Items, "itemGroup.name.skull" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_9 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::ENCHANTED_BOOK = ItemGroup{ ItemCategory::Items, "itemGroup.name.enchantedBook" };
ItemGroup ItemGroupRegistry::BOAT = ItemGroup{ ItemCategory::Items, "itemGroup.name.boat" };
ItemGroup ItemGroupRegistry::CHESTBOAT = ItemGroup{ ItemCategory::Items, "itemGroup.name.chestboat" };
ItemGroup ItemGroupRegistry::RAIL = ItemGroup{ ItemCategory::Items, "itemGroup.name.rail" };
ItemGroup ItemGroupRegistry::MINECART = ItemGroup{ ItemCategory::Items, "itemGroup.name.minecart" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_10 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::BUTTONS = ItemGroup{ ItemCategory::Items, "itemGroup.name.buttons" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_11 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::PRESSURE_PLATE = ItemGroup{ ItemCategory::Items, "itemGroup.name.pressurePlate" };
ItemGroup ItemGroupRegistry::ITEMS_EMPTY_12 { ItemCategory::Items }; // Empty Group
ItemGroup ItemGroupRegistry::BANNER = ItemGroup{ ItemCategory::Items, "itemGroup.name.banner" };
ItemGroup ItemGroupRegistry::BANNER_PATTERN = ItemGroup{ ItemCategory::Items, "itemGroup.name.banner_pattern" };
ItemGroup ItemGroupRegistry::POTTERY_SHERDS = ItemGroup{ ItemCategory::Items, "itemGroup.name.potterySherds" };
ItemGroup ItemGroupRegistry::SMITHING_TEMPLATE = ItemGroup{ ItemCategory::Items, "itemGroup.name.smithing_templates" };
ItemGroup ItemGroupRegistry::FIREWORK = ItemGroup{ ItemCategory::Items, "itemGroup.name.firework" };
ItemGroup ItemGroupRegistry::FIREWORK_STARS = ItemGroup{ ItemCategory::Items, "itemGroup.name.fireworkStars" };
